...
export const interactiveFields: INodeProperties[] = [
	...
	},
	{
		...
		default: {},
		description:
			'Up to ten rows across all sections. Rows sharing a section title are grouped together, in the order the titles first appear.',
		displayOptions: show({ interactiveType: ['list'] }),
		options: [
			{
				displayName: 'Row',
				...
				values: [
					{
						...
						description: 'Groups rows under a heading. Leave empty for a single unnamed section.',
					},
					{
						displayName: 'Title',
						name: 'title',
